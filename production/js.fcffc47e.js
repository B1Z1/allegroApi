...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"../js/modules/APIAllegro/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.APIAllegro = void 0;
...
var NOTFOUND_ACTIVE_CLASS = "m-Window__notfound--active";
var CLOSE_ACTIVE_CLASS = "m-Window__close--active";
var REQUEST_HEADER_CODE = "application/vnd.allegro.public.v1+json";

var APIAllegro =
/*#__PURE__*/
function () {
  function APIAllegro() {
    _classCallCheck(this, APIAllegro);
    ...
    this.clientSecretID = "Zsg5uGBgJN3TFYwWweQhF0U5k42sRWyGa8kpCYEeGDhtAHMswBgfJ7NuPahJVLPN";
    this.link = "https://allegro.pl/auth/oauth/token?grant_type=client_credentials";
    this.OAuthHeader = {
      Authorization: "Basic ".concat(btoa("".concat(this.clientID, ":").concat(this.clientSecretID))),
      ContentType: "Content-Type: application/x-www-form-urlencoded"
    };
    this.requestHeader = {};
    this.listOfProducts = []; //Request OAuth Allegro

    this.OAuthRequest = _axios.default.create({
      method: "post",
      headers: this.OAuthHeader
    });
    this.APIRequest = _axios.default.create({
      method: "get"
    });
    if (this.$Window && this.$WindowForm && this.$WindowNotFound && this.$WindowClose && this.$WindowClose && this.$WindowInput) this.init();
  }
  /**
   * @function init
   */
  ...
  _createClass(APIAllegro, [{
    key: "init",
    value: function init() {
      var _this = this;

      this.$WindowForm.addEventListener("submit", function (ev) {
        ev.preventDefault();
        _this.currentSearchItem = _this.$WindowForm.search.value.replace(/[ ,./+-]+/g, "+");

        _this.OAuthRequest.post(_this.link).then(function (response) {
          _this.requestHeader.Authorization = response.data.access_token;
          _this.APIRequest.defaults.headers.common["Authorization"] = "bearer ".concat(_this.requestHeader.Authorization);
          _this.APIRequest.defaults.headers.common["Accept"] = REQUEST_HEADER_CODE;
          _this.APIRequest.defaults.headers.common["ContentType"] = REQUEST_HEADER_CODE;

          _this.getListOffers();
        });
      });
      this.$WindowInput.addEventListener("keyup", function () {
        _this.onInputChange();
      });
      this.$WindowClose.addEventListener("click", function (ev) {
        ev.preventDefault();
    ...
    value: function onInputChange() {
      if (this.$WindowInput.value.length > 0) this.$WindowClose.classList.add(CLOSE_ACTIVE_CLASS);else this.$WindowClose.classList.remove(CLOSE_ACTIVE_CLASS);
    }
    /**
    ...
    key: "getListOffers",
    value: function getListOffers() {
      var _this2 = this;

      this.APIRequest.get("https://api.allegro.pl/offers/listing?phrase=".concat(this.currentSearchItem, "&sort=-popularity&limit=100&offset=0&include=+all")).then(function (response) {
        _this2.listOfItems = response.data.items.promoted;

        _this2.insertProducts();
      }, function (error) {
        console.log(error);
      });
    }
      ...
      if (this.listOfItems.length === 0) {
        ...
        this.listOfItems.forEach(function (item) {
          var name = item.name.toLowerCase(),
              ...
              price = "".concat(item.sellingMode.price.amount, " ").concat(item.sellingMode.price.currency),
              link = item.id,
              productElement = _this3.productTemplate(image, name, price, sells, link);

          _this3.$Window.appendChild(productElement);
        });
      }
    }
    /**
...
exports.APIAllegro = APIAllegro;
},{"axios":"../../node_modules/axios/index.js"}],"../js/index.js":[function(require,module,exports) {
"use strict";

require("../style/style.scss");

var _APIAllegro = require("./modules/APIAllegro");

/* Libs */
window.addEventListener("load", function () {
  new _APIAllegro.APIAllegro();
});
},{"../style/style.scss":"../style/style.scss","./modules/APIAllegro":"../js/modules/APIAllegro/index.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
